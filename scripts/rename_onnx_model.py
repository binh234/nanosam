...
def parse_arguments():
    ...
    parser.add_argument(
        "--model", "-m", required=True, help="Path of directory saved the input model."
    )
    parser.add_argument(
        "--origin_names", required=True, nargs="+", help="The original name you want to modify."
    )
    parser.add_argument(
        "--new_names",
        required=True,
    ...
    parser.add_argument("--output", "-o", required=True, help="Path to save the new onnx model.")
...
if __name__ == "__main__":
    ...
    print("[Finished] The new model saved in {}.".format(args.output))
