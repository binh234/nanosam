...
def download_sa1b_chunk_txt(directory, filename="data_urls.txt"):
    ...
    if not os.path.exists(path):
        txt_url = "https://scontent.fsgn5-6.fna.fbcdn.net/m1/v/t6/An8MNcSV8eixKBYJ2kyw6sfPh-J9U4tH2BV7uPzibNa0pu4uHi6fyXdlbADVO4nfvsWpTwR8B0usCARHTz33cBQNrC0kWZsD1MbBWjw.txt?ccb=10-5&oh=00_AfC5wFOZk5DsGhEQenvbC1s2PEUKIVRZHb4fJViX_LBOyw&oe=662B8818&_nc_sid=0fdd51"
